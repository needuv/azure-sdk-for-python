...
@pytest.mark.e2etest
class TestDatastore(MlRecordedTest):
    ...
    def test_blob_store(
        ...
        **kwargs,
        ...
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        storage_account_name = kwargs.get("ml_test_storage_account_name")
        primary_account_key = kwargs.get("ml_test_storage_account_primary_key")
        secondary_account_key = kwargs.get("ml_test_storage_account_secondary_key")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_adls_gen_1_store(self, adls_gen1_file: str, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    def test_credential_less_adls_gen_1_store(
        self, adls_gen1_credential_less_file: str, randstr: Callable[[], str], **kwargs
    ) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_adls_gen2_store(self, adls_gen2_file: str, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    def test_credential_less_adls_gen2_store(
        self, adls_gen2_credential_less_file: str, randstr: Callable[[], str], **kwargs
    ) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
