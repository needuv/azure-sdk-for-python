...
class TestUpload:
    ...
    def test_upload_file_blob(
        self, dir_asset_id: str, file_asset_id: str, **kwargs
    ) -> None:
        storage_account_name = kwargs.get("ml_test_storage_account_name")
        storage_account_secret = kwargs.get("ml_test_storage_account_primary_key")
    ...
    def test_artifact_blob_file_upload(
        self, artifact_path: str, uuid_name: str, **kwargs
    ) -> None:
        storage_account_name = kwargs.get("ml_test_storage_account_name")
        storage_account_secret = kwargs.get("ml_test_storage_account_primary_key")
    ...
    def test_artifact_blob_dir_upload_and_download(
        self, artifact_path_dir: str, uuid_name: str, **kwargs
    ) -> None:
        storage_account_name = kwargs.get("ml_test_storage_account_name")
        storage_account_secret = kwargs.get("ml_test_storage_account_primary_key")
        name, version = _parse_name_version(uuid_name)
