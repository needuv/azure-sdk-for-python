...
@pytest.mark.e2etest
@pytest.mark.mlc
class TestWorkspace(MlRecordedTest):
    @MlPreparer()
    @recorded_by_proxy
    def test_workspace_create_update_and_delete(
        self, randstr: Callable[[], str], location: str, **kwargs
    ) -> None:
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_workspace_diagnosis(self, **kwargs) -> None:
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_workspace_cmk_create_and_delete(self, randstr: Callable[[], str], **kwargs) -> None:
