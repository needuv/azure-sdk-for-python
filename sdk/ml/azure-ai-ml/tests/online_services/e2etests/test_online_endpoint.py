...
from azure.ai.ml.constants import ComputeType, AML_TOKEN_YAML, KEY
...
from azure.ai.ml.constants import EndpointKeyType
...
from azure.ai.ml.entities import OnlineEndpoint, KubernetesOnlineEndpoint
...
class TestOnlineEndpoint(MlRecordedTest):
    @MlPreparer()
    @recorded_by_proxy
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_online_endpoint_submit(self, location: str, **kwargs):
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    def test_online_endpoint_k8s_empty_model_e2e(
        ...
        **kwargs
        ...
        with pytest.raises(Exception) as e:
            endpoint = OnlineEndpoint.load(endpoint_k8s_yaml_empty_model)
...
def run_endpoint_tests_e2e_create(
    ...
    try:
        ...
        endpoint = OnlineEndpoint.load(endpoint_file)
