...
class TestComponent(MlRecordedTest):
    @MlPreparer()
    @recorded_by_proxy
    def test_command_component_create(self, randstr: Callable[[], str], **kwargs) -> None:
    ...
    def test_command_component_create_input_output_types(
        self, randstr: Callable[[], str], component_path: str, **kwargs,
    ) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        for name, input_obj in component_entity.inputs.items():
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_command_component_with_code(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_list(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_update(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        assert target_entity._source == "REST"
...
environment: azureml:AzureML-sklearn-0.24-ubuntu18.04-py37-cpu:1"""
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_update_code(self, randstr: Callable[[], str], tmp_path: Path, **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_create_default_code(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_mpi_component(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        mpi_distribution = {"distribution_type": "Mpi", "process_count_per_instance": 1}
        assert mpi_distribution == component_entity.distribution.as_dict()
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_pytorch_component(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        assert component_entity.distribution.as_dict() == torch_distribution
        ...
        assert torch_component_resource.distribution.as_dict() == torch_distribution

    @MlPreparer()
    @recorded_by_proxy
    def test_tensorflow_component(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        assert component_entity.distribution.as_dict() == tensorflow_distribution
        tensorflow_component_resource = client.components.create_or_update(component_entity)
        assert tensorflow_component_resource.distribution.as_dict() == tensorflow_distribution
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_anonymous_component_reuse(self, **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        component_resource1 = create_component(
            client, _sanitize_python_variable_name(str(uuid.uuid4())), is_anonymous=True
        )
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_command_component_dependency_label_resolution(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_command_component_get_latest_label(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_command_component_delete_latest_label(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_anonymous_registration_from_load_component(self, **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_archive_restore_version(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_archive_restore_container(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_entity_command_component_create(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_validate_via_schema(self, **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
    ...
    @MlPreparer()
    @recorded_by_proxy
    def test_component_create_get_from_registry(
        self, randstr: Callable[[], str], **kwargs
    ) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")

        registry_client = self.create_registry_ml_client(subscription_id=subscription_id, resource_group_name=resource_group)
        component_name = randstr()

        component_resource = create_component(registry_client, component_name)
        assert component_resource.name == component_name
        assert component_resource.code
        assert component_resource.creation_context

        component = registry_client.components.get(component_name, component_resource.version)
        assert component_resource._to_dict() == component._to_dict()
        assert component_resource.creation_context

    @MlPreparer()
    @recorded_by_proxy
    def test_parallel_component_create(self, randstr: Callable[[], str], **kwargs) -> None:
        subscription_id = kwargs.get("ml_subscription_id")
        resource_group = kwargs.get("ml_resource_group")
        ...
        component_resource = client.components.create_or_update(parallel_component)
        assert component_resource.version == "2"
